...
model = dict(
    ...
    depth_pretrained_path = '/home/ubuntu/deeplabv3/pretrained_models/resnet50-19c8e357.pth'.format(DEPTH_LAYERS), # pretrained weights for resnet
    pose_pretrained_path =  '/home/ubuntu/deeplabv3/pretrained_models/resnet18-5c106cde.pth'.format(POSE_LAYERS),# pretrained weights for resnet
